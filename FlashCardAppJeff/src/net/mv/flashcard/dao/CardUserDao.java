...
public class CardUserDao {
	...
	/*
	 * So, if the method does not find a user by username, it will return null.
	 */
	...
	/*
	 * Method to insert CardUser into the db. 
	 * Throws a SQLException to the calling code if
	 * a CardUser exists (SQLException).
	 */
